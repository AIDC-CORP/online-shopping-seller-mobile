...
import { mockStoreInfo } from '../services/mockData';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="pt-10">
        ...
        <p className="text-sm text-gray-500 mt-1">{storeInfo.description}</p>
      </div>

      <div className="bg-white p-4 rounded-lg shadow-sm">
        <h3 className="text-lg font-semibold text-gray-800 mb-2">Thông tin cửa hàng</h3>
